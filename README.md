...
**METHOD 1 - UNINSTALLATION - EASY - Most Reliable Solution (AF)**
...
**METHOD 2 - SERVER DISCONNECTION - EASY AS F\*CK - Easiest Solution (F)**
...
**METHOD 3 - THE FIREWALL - SEMI COMPLEX - Most Reliable without Uninstallation (AF)**
...
**METHOD 4 - SOFTWARE - SIMPLE - Best for Transporting to Other Computers (AF)**
...
**METHOD 5 - USB WINDOWS INSTALL - ADVANCED AS F\*CK - For those without Admin that can afford to spend a bit of $ (C)**
